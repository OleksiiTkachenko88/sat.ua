 ...
 */
$min_builderPassword = 'sat@admin_us7eJ';
...
require "$min_libPath/Minify/Cache/File.php";
$min_cachePath = new Minify_Cache_File();
 ...
 * upd ate the mtime on the server. If the mtime jumps ahead by a number of hours,
 * se t this variable to that number. If the mtime moves back, this should not be 
 * needed.
 *
