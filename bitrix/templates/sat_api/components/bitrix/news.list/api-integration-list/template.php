                ...
                <div class="col-xs-12">
                    <div class="border-block">
						<div class="breadcrumbs">
							...
							<span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"> 
								<span itemprop="title"><?=getMessage("API_INTEGRATION_HEADER")?></span> 
							</span>
						</div>
                        <div class="header clearfix">
                            <div class="img-wrap">
                                <img src="<?=SITE_TEMPLATE_PATH?>/img/icons/api-integration-icon.png" alt="">
                            </div>
                            <h1><?=getMessage("API_INTEGRATION_HEADER")?></h1>
                        </div>
...
<? $i ++ ; ?>
                                ...
                                <a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="inner-new">
                                    <div class="news-image prev-integration-image">
