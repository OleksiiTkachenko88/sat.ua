...
?>
	...
	<form role="form" method="post" action2="<?=$arResult["FORM_ACTION"]?>"  onsubmit="BX('bx_subscribe_btn_<?=$buttonId?>').disabled=true;" action="">
		<?=bitrix_sessid_post()?>
		<input type="hidden" name="sender_subscription" value="add">
		<input name="SENDER_SUBSCRIBE_EMAIL" type="email" class="text-field" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>" value="<?=$arResult["EMAIL"]?>">
        <input type="submit" class="submit sender-btn btn-subscribe" value="<?=GetMessage("subscr_form_button")?>" id="bx_subscribe_btn_<?=$buttonId?>">
