...
?>
<link type="text/css" rel="stylesheet" href="/min/?g=sat_main_20200606" />
...
<header>
    <div class="container">
        <div class="row">
            <div class="col-xs-26">
<div id="header"><p><?echo getMessage("SHAPKA")?></p> </div>
                <div class="clearfix header-inner">
                    ...
                    <a href="<?= SITE_DIR ?>" class="logo">
                        <img src="<?=SITE_TEMPLATE_PATH?>/img/header-logo-text.png" alt="<?echo getMessage("ALT_MAIN_LOGO")?>">
                    </a>
...
<a class="login-link" href="https://cabinet.sat.ua"><img src="<?=SITE_TEMPLATE_PATH?>/img/icons/login.png"></a>
...
<script id="bx24_form_button" data-skip-moving="true">
  ...
  })(window,document,'https://portal.sat.ua/bitrix/js/crm/form_loader.js','b24form');

  b24form({"id":"8","lang":"ru","sec":"ux3v5v","type":"button","click":""});
</script>
<a class="call-btn b24-web-form-popup-btn-8"><img src="<?=SITE_TEMPLATE_PATH?>/img/icons/call.png"></a>
		...
		"PATH" => SITE_TEMPLATE_PATH . "/include/top_phone_inc.php"
                    ...
                    <div class="order-form header-inputs-form hidden-block">
                        <div class="inner-form">
                            <div class="inputs-row clearfix simple_calc_row"><div class="loader"></div><form id="simple_calc" action="#" method="post" class="clearfix">
                                ...
                                <input type="submit" class="order-button" value="<?echo getMessage("COUNT");?>"></form>
                            </div>
                            <div class="results-row clearfix" style="display:none;">
                                <div class="results">
                                    ...
                                    <div class="result-item from-to">
                                        <div><span id="simple_calc_from_text">Київ</span> - <span id="simple_calc_to_text">Кам'янець-Подiльский</span></div>
                                    </div>
                                    <div class="result-item border-result">
                                        <div><span><span id="simple_calc_weight_text">500</span> кг</span></div>
                                    </div>
                                    <div class="result-item border-result">
                                        <div><span><?echo getMessage("FROM_PRICE");?> <span id="simple_calc_result_text">47 325</span> грн</span></div>
                                    </div>
                                </div>
                                <input type="submit" class="order-button" value="<?echo getMessage("MAKE_ORDER");?>">
                            </div>
                        </div>
                    </div>
...
<?
$APPLICATION->IncludeFile(SITE_TEMPLATE_PATH . "/include/panel_btns_" . GetMessage("IBLOCK_TYPE") . "_inc.php", Array(), Array(
    "MODE"      => "text"
    ));
?>
    </div>
