...
<a class="lang" href="<?echo $page?>" id="<?echo SITE_DIR == '/' ? 'UA' : 'RU';?>">
  <span class="lang-icon"><?echo SITE_DIR == '/' ? 'UA' : 'RU';?></span>
					...
					<a class="login-link" href="https://cabinet.sat.ua/?utm_source=sat.ua-baner&utm_medium=link&utm_campaign=LK-SATUA"><img src="<?=SITE_TEMPLATE_PATH?>/img/icons/login.png"></a>
