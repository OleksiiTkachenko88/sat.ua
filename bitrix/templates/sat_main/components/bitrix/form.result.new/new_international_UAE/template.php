...
<?endif;?>
	...
	<?endforeach;?>
			...
			<div class="input-group" title="<?echo GetMessage("Q_FIO")?>">
				...
				<input type="text" class="inputtext form-control user" name="form_text_53" value="<?=$_POST["form_text_53"]?>" placeholder="<?echo GetMessage("Q_FIO")?>">
			</div>
			<?endif;?>
			...
			<div class="input-group" title="<?echo GetMessage("Q_PHONE")?>">
				...
				<input type="text" class="inputtext form-control phone" name="form_text_54">
			</div>
			<?endif;?>
			...
			<div class="input-group" title="<?echo GetMessage("Q_MAIL")?>">
				...
				<input type="text" class="inputtext form-control mail" name="form_text_55">
			</div>
			<?endif;?>

<?if($arQuestionsCheck["SIMPLE_QUESTION_719"]["ACTIVE"] == "Y"):?>
			<div class="input-group" title="<?echo GetMessage("Q_TYP")?>">
				<div class="input-group-addon">
				<i class="fa fa-dropbox fa-2x" aria-hidden="true"></i>
				</div>
				<input type="text" class="inputtext form-control" name="form_text_61" value="<?=$_POST["form_text_61"]?>" placeholder="<?echo GetMessage("Q_TYP")?>">
			</div>
			<?endif;?>

			<?if($arQuestionsCheck["SIMPLE_QUESTION_995"]["ACTIVE"] == "Y"):?>
			<div class="input-group" title="<?echo GetMessage("Q_WEIGHT")?>">
				<div class="input-group-addon">
				<i class="fa fa-dropbox fa-2x" aria-hidden="true"></i>
				</div>
				<input type="text" class="inputtext form-control" name="form_text_60" value="<?=$_POST["form_text_60"]?>" placeholder="<?echo GetMessage("Q_WEIGHT")?>">
			</div>
			<?endif;?>

			<?if($arQuestionsCheck["SIMPLE_QUESTION_416"]["ACTIVE"] == "Y"):?>
			<div class="input-group" title="<?echo GetMessage("Q_DIMENSIONS")?>">
				<div class="input-group-addon">
				<i class="fa fa-dropbox fa-2x" aria-hidden="true"></i>
				</div>
				<input type="text" class="inputtext form-control" name="form_text_56" value="<?=$_POST["form_text_56"]?>" placeholder="<?echo GetMessage("Q_DIMENSIONS")?>">
			</div>
			<?endif;?>
			...
			<div class="country-block">
				<div class="input-group country" title="<?echo GetMessage("Q_COUNTRY_FROM")?>">
					...
					<input type="text" class="inputtext form-control country-from" name="form_text_57" value"<?=$_POST["form_text_57"]?>" placeholder="<?echo GetMessage("Q_COUNTRY_FROM")?>">
				</div>
				...
				<div class="input-group country" title="<?echo GetMessage("Q_COUNTRY_TO")?>">
					...
					<input type="text" class="inputtext form-control country-to" name="form_text_58" value="<?=$_POST["form_text_58"]?>" placeholder="<?echo GetMessage("Q_COUNTRY_TO")?>">
				</div>
			</div>
			<?endif;?>
			<?if($arQuestionsCheck["SIMPLE_QUESTION_304"]["ACTIVE"] == "Y"):?>
			<div class="additional-information" title="<?echo GetMessage("Q_ADDITIONAL_INFO")?>">
				<textarea name="form_textarea_59" cols="40" rows="5" class="inputtextarea form-control" maxlength="300" value="<?=$_POST["form_text_59"]?>" placeholder="<?echo GetMessage("Q_ADDITIONAL_INFO")?>"></textarea>
			</div>
			<?endif;?>
