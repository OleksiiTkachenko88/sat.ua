...
<?endif;?>
	...
	<?endforeach;?>
			...
			<?if($arQuestionsCheck["REGION_QUESTION_1271"]["ACTIVE"] == "Y"):?>
			<div class="input-group" title="<?echo GetMessage("Q_FIO")?>">
				<div class="input-group-addon">
				<i class="fa fa-user fa-2x" aria-hidden="true"></i>
				</div>
				<input type="text" class="inputtext form-control user" name="form_text_499" value="<?=$_POST["form_text_499"]?>" placeholder="<?echo GetMessage("Q_FIO")?>">
			</div>
			<?endif;?>

			<?if($arQuestionsCheck["REGION_QUESTION_9171"]["ACTIVE"] == "Y"):?>
			<div class="input-group" title="<?echo GetMessage("Q_PHONE")?>">
				<div class="input-group-addon">
				<i class="fa fa-mobile fa-2x" aria-hidden="true"></i>
				</div>
				<input type="text" class="inputtext form-control phone" name="form_text_500" value="<?=$_POST["form_text_500"]?>" placeholder="<?echo GetMessage("Q_PHONE")?>">
			</div>
			<?endif;?>
			<div class="btn-block">
				<div class="rate-wrap">
