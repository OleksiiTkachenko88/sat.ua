...
<?endif;?>
	...
	<?endforeach;?>
			...
			<?if($arQuestionsCheck["REGION_QUESTION_127"]["ACTIVE"] == "Y"):?>
			<div class="input-group" title="<?echo GetMessage("Q_FIO")?>">
				<div class="input-group-addon">
				<i class="fa fa-user fa-2x" aria-hidden="true"></i>
				</div>
				<input type="text" class="inputtext form-control user" name="form_text_490" value="<?=$_POST["form_text_490"]?>" placeholder="<?echo GetMessage("Q_FIO")?>">
			</div>
			<?endif;?>

			<?if($arQuestionsCheck["REGION_QUESTION_917"]["ACTIVE"] == "Y"):?>
			<div class="input-group" title="<?echo GetMessage("Q_PHONE")?>">
				<div class="input-group-addon">
				<i class="fa fa-mobile fa-2x" aria-hidden="true"></i>
				</div>
				<input type="text" class="inputtext form-control phone" name="form_text_491" value="<?=$_POST["form_text_491"]?>" placeholder="<?echo GetMessage("Q_PHONE")?>">
			</div>
			<?endif;?>
			<div class="btn-block">
				<div class="rate-wrap">
