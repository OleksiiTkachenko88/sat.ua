...
<a class="login-link" href="https://cabinet.sat.ua<?= $page_lang === 'ru' ? '/ru' : '/ua' ?>/?utm_source=sat.ua-baner&utm_medium=link&utm_campaign=LK-SATUA"><img src="<?=SITE_TEMPLATE_PATH?>/img/icons/login.png"></a>
