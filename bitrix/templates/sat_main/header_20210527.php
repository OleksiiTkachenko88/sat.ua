...
<head>
    ...
    <meta name="facebook-domain-verification" content="abzg68c6ffj532fcrk9vesa6lz53pj" />
...
?>
<link type="text/css" rel="stylesheet" href="/min/?g=20210331" />
                        ...
                        <div class="results-row clearfix" style="display:none;">
                          <div class="results">
                            ...
                            <div class="result-item border-result">
                              <div>
                                <span><span id="simple_calc_weight_text">500</span> кг</span>
                              </div>
                            </div>
                            <div class="result-item border-result">
                              <div>
