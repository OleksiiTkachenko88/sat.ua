...
$APPLICATION->SetPageProperty("H1", "Доставка из ОАЭ в Украину");
$APPLICATION->SetPageProperty("description", "Доставка вантажу, товарів з еміратів (ОАЕ) в Україну - ТК \"САТ\" | ВИГІДНО! НАДІЙНО! ПІД ЧАС! ☎ 0 800 30 99 09 (безкоштовно по Україні)");
$APPLICATION->SetPageProperty("title", "Міжнародні авіаперевезення SAT | Доставка документів та вантажів авіатранспортом в більш ніж 220 країн світу");
$APPLICATION->SetTitle("Международная доставка SAT");
?>
<div class="international-banner" style="background-image: url('<?=SITE_TEMPLATE_PATH;?>/img/16-укр.png');">
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
				<div class="international-banner-content">
					<div class="international-banner-text clearfix">
						<h1><?echo getMessage("AVIA");?></h1>
			...
			<div class="col-xs-12">
				<div class="post-content">
					<div class="breadcrumbs">
						...
						<span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"> 
							<span itemprop="title"><?echo getMessage("AVIA");?></span> 
						</span>
					</div>
...
<?$APPLICATION->IncludeComponent("bitrix:form.result.new", "new_international_UAE", Array(
	"CACHE_TIME" => "3600",	// Время кеширования (сек.)
		...
		"SEF_FOLDER" => "/international/avia/",	// Каталог ЧПУ (относительно корня сайта)
