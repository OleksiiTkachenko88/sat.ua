...
$APPLICATION->SetPageProperty("description", "Міжнародна доставка SAT | ВИГІДНО! НАДІЙНО! ВЧАСНО! ☎ 066 830 99 09; 098 830 99 09; 073 830 99 09 (вартість дзвінків згідно тарифів вашого оператора)");
$APPLICATION->SetPageProperty("title", "Міжнародні перевезення вантажів | Дешеві міжнародні вантажоперевезення ТК \"САТ\"");
$APPLICATION->SetTitle("Міжнародна доставка SAT");
?>
<div class="international-banner" style="background-image: url('<?=SITE_TEMPLATE_PATH;?>/img/international-baner2.jpg');">
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
