...
$APPLICATION->SetPageProperty("description", "Доставка грузов по Украине быстро! качественно! надежно! | Доставка грузов по Украине от транспортной компании \"САТ\" | Аккуратные грузоперевозки по Киеву и Украине | Низкие тарифы на перевозки по Украине | On-Line отслеживание статуса груза на сайте компании | Заказать перевозку грузов по телефону 0 800 30 99 09");
$APPLICATION->SetPageProperty("title", "Перевозка грузов - Перевозки по Украине с транспортной компанией \"САТ\"");
                ...
                <div class="col-xs-12 col-sm-6 col-aside">
                    <div class="border-block aside-page">
                        <div class="header clearfix">
                            ...
                            <span><?echo 'SAT ' . getMessage("RECOMMEND");?></span>
                        </div>
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"SORT_ORDER2" => "DESC"
                        ...
                        <div class="clearfix">
                            <a href="<?=SITE_DIR?>about/recommend/" class="button-more"><span class="text"><?echo 'SAT ' . getMessage("RECOMMEND");?></span><span
                                    class="arrow"><img
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"CACHE_TYPE" => "A",
		"CHECK_DATES" => "Y",
		"DETAIL_URL" => "https://franchise.sat.ua/",
		"DISPLAY_BOTTOM_PAGER" => "Y",
		"DISPLAY_DATE" => "Y",
		"DISPLAY_NAME" => "Y",
		"DISPLAY_PICTURE" => "Y",
		...
		"SORT_ORDER1" => "DESC",
		"SORT_ORDER2" => "DESC",
		"COMPONENT_TEMPLATE" => "innerpartner",
		"STRICT_SECTION_CHECK" => "N"
	),
	false
);?>
