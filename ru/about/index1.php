...
$APPLICATION->SetPageProperty("description", "Подробно о логистеческой компании “САТ” | ВЫГОДНО! НАДЕЖНО! ВОВРЕМЯ! ☎ 0 800 30 99 09 (бесплатно по Украине)");
...
?>
   ...
   <div class="strategy-banner" style="background-image: url('<?=SITE_TEMPLATE_PATH;?>/img/strategy-banner-rus.jpg');">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-xs-12">
					...
					<div class="breadcrumbs">
						...
						<span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"> 
							<span itemprop="title"><?echo $APPLICATION->GetDirProperty("H7");?></span> 
						</span>
					</div>
<?
