...
$APPLICATION->SetPageProperty("description", "Подробно о логистеческой компании “САТ” | ВЫГОДНО! НАДЕЖНО! ВОВРЕМЯ! ☎ 066 830 99 09; 098 830 99 09; 073 830 99 09 (стоимость звонков согласно тарифов вашего оператора)");
$APPLICATION->SetPageProperty("title", "Логистическая компания Украина | О компании “САТ” - Транспортная логистика");
$APPLICATION->SetTitle("SAT – ЛОГИСТИКА ДЛЯ БИЗНЕСА");
$APPLICATION->SetPageProperty("H2", "БЕЗУПРЕЧНО ДОСТАВЛЯЕМ ГРУЗЫ ПО УКРАИНЕ И МИРУ");
?>

   <div class="strategy-banner" style="background-image: url('<?=SITE_TEMPLATE_PATH;?>/img/strategy-banner-ru-new.png');">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
