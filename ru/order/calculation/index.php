...
$APPLICATION->SetPageProperty("description", "Рассчитать стоимость перевозки - Транспортная компания “САТ” | ВЫГОДНО! НАДЕЖНО! ВОВРЕМЯ!");
$APPLICATION->SetPageProperty("title", "Рассчитать стоимость перевозки | Транспортная компания “САТ”");
$APPLICATION->SetTitle("Рассчитать стоимость перевозки");
...
function getConditionsOptions($url) {
  $host = 'https://catalog.sat.ua/';
  $apiLang = getMessage('API_LANG');
  $tmp = file_get_contents("{$host}{$url}?language={$apiLang}");
  if (!$tmp) return '';
...
$departureConditionsOptions = getConditionsOptions('getDepartureConditions');
$deliveryConditionsOptions = getConditionsOptions('getDeliveryConditions');
...
<style>
  ...
  .declaration-recomended-services {
    border-top: 1px solid #bbb;
  }

  .declaration-recomended-services .pb {
    padding-top: 10px !important;
  }

  .declaration-recomended-services input {
    margin-right: 10px;
  }

  .declaration-recomended-services input:checked ~ span {
    color: #404041;
  }
      ...
      <div class="col-xs-12">
        <div class="tracking-table">
              ...
              <div class="parcel-main-info clearfix">
                ...
                <div class="main-info-item">
                 ...
                 <!-- <div class="main-info-row">
                  ...
                  <div class="main-info-row">
                    <label
                      data-text-default="<?= GetMessage("WEIGHT"); ?>"
                      data-text-basic="<?= GetMessage("TOTAL_WEIGHT"); ?>"
                    >
                      <?= GetMessage("WEIGHT"); ?>
                    </label>
                    <div class="field-wrap">
                  ...
                  <div class="main-info-row">
                    ...
                    <div class="field-wrap">
                      <input type="number" placeholder="0" id="totalWeight"/>
                      <span><?=GetMessage("KG");?></span>
                    </div>
                  </div>
                  <div class="main-info-row">
                  ...
                  <div class="main-info-row">
                    <label
                      data-text-default="<?= GetMessage("OBJEM"); ?>"
                      data-text-basic="<?= GetMessage("TOTAL_OBJEM"); ?>"
                    >
                      <?= GetMessage("OBJEM"); ?>
                    </label>
                    <div class="field-wrap">
                  ...
                  <div class="main-info-row">
                    ...
                    <div class="field-wrap">
                      <input type="number" placeholder="0" id="declaredCost" min="500" max="50000" />
                      <span>грн</span>
                    </div>
                  </div>
                </div>
                ...
                <div class="main-info-item">
                  <div class="main-info-row calculator-info" id="infoTypeOfCargo">
                    <div class="calculator-info__title"id="infoTitleTypeOfCargo"><!-- ajax --></div>
                    <ul class="calculator-info__wrapper-list" id="infoOptionsTypeOfCargo"><!-- ajax --></ul>
                  </div>

                  <div class="polupalet">Услуга применяется при условии предоставления Клиентом собственной паллеты, размеры которой не превышают 80х60 см.</div> 

                  <div class="main-info-row calculator-info" id="recomendedServices">
                    <div class="calculator-info__title">
                      <?= GetMessage("RECOMMENDED_PACKAGING");?>:
                    </div>

                    <ul class="calculator-info__wrapper-list" id="recomendedServicesList"><!-- ajax --></ul>
                  </div>
                </div>
              </div>
              ...
              <div class="declaration clearfix">
                  ...
                  <div class="right-info">
                          ...
                          <tr>
                              ...
                              <td></td>
                              <td></td>
                              <td class="dark right"><span id="decCost"></span> грн</td>
                          </tr>
                      </table>
                      <table class="border">
                          <tr>
                      ...
                      <table>
                        <tr>
                          <td class="big-text dark"><?=GetMessage("COST");?></td>
                          <td class="big-text dark right"><span id="totalCost"></span> грн</td>
                        </tr>
                      </table>

                      <table class="declaration-recomended-services" id="declarationRecomendedServices">
                        <tr>
                          <td class="dark pb" colspan="2"><?= GetMessage("RECOMMENDED_PACKAGING");?>:</td>
                        </tr>
                        <!-- Added class for ajax result  -->
                        <tr id="declarationRecomendedServicesWrapperCost">
                          <td class="big-text dark"><?= GetMessage("COST_RECOMMENDED_PACKAGING");?></td>
                          <td class="big-text dark right">
                            <span id="declarationRecomendedServicesCost"></span>&nbsp;грн
                          </td>
                        </tr>
                      </table>
                      
                      <div id="warningLathing" class="warning-lathing"><?= GetMessage("WARNING_LATHING");?></div>
              </div>
              </div>
          ...
          <div class="wrapper-btns">
                      ...
                      <div class="error-calc">Системна помилка</div> 
...
<script src="<?=SITE_TEMPLATE_PATH?>/js/date-lib.js?20220804"></script>
<script src="<?=SITE_TEMPLATE_PATH?>/js/calcDates.js?20220804"></script>
<script src="<?=SITE_TEMPLATE_PATH?>/js/orderCalculation.js?20220804"></script>
