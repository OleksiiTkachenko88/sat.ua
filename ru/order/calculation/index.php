...
$APPLICATION->SetPageProperty("description", "Рассчитать стоимость перевозки - Транспортная компания “САТ” | ВЫГОДНО! НАДЕЖНО! ВОВРЕМЯ! ☎ 066 830 99 09; 098 830 99 09; 073 830 99 09 (стоимость звонков согласно тарифов вашего оператора)");
          ...
          <div class="declaration-wrapper clearfix">
              ...
              <div class="declaration clearfix">
                  ...
                  <div class="right-info">
                      ...
                      <table>
                        <tr>
                          <td class="big-text"><?=GetMessage("DECLARED_COST");?></td>
...
<script src="<?=SITE_TEMPLATE_PATH?>/js/calcDates.js?20201219"></script>
<script src="<?=SITE_TEMPLATE_PATH?>/js/orderCalculation.js?20211206"></script>
