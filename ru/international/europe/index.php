...
$APPLICATION->SetPageProperty("description", "Международные перевозки по всей Европе ТК “САТ” | ВЫГОДНО! НАДЕЖНО! ВОВРЕМЯ! ☎ 0 800 30 99 09 (бесплатно по Украине)");
$APPLICATION->SetPageProperty("title", "Международные перевозки грузов | Дешевые международные грузоперевозки ТК \"САТ\"");
			...
			<div class="col-xs-12">
				<div class="international-banner-content">
					<div class="international-banner-text clearfix">
						<h1><?echo getMessage("EUROPE");?></h1>
						<h2><?echo getMessage("EUROPE2");?></h2>
					</div>
				</div>
			</div>
		</div>
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"SEF_FOLDER" => "/ru/international/europe/",
