...
$APPLICATION->SetPageProperty("description", "Международные перевозки по всей Европе ТК “САТ” | ВЫГОДНО! НАДЕЖНО! ВОВРЕМЯ! ☎ 066 830 99 09; 098 830 99 09; 073 830 99 09 (стоимость звонков согласно тарифов вашего оператора)");
$APPLICATION->SetPageProperty("title", "Международные перевозки SAT: гарантированные скорость и надёжность");
$APPLICATION->SetTitle("Международные перевозки SAT: гарантированные скорость и надёжность");
?>
<div class="international-banner" style="background-image: url('<?=SITE_TEMPLATE_PATH;?>/img/international-baner2-ru.jpg');">
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
				<div class="international-banner-content">
					<div class="international-banner-text clearfix">
						<h1><?echo getMessage("MD");?></h1>
                        <h2><?echo getMessage("MD2");?></h2>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-xs-12">
				<div class="post-content">
					<div class="breadcrumbs">
						...
						<span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"> 
							<span itemprop="title"><?echo $APPLICATION->GetDirProperty("MD");?></span> 
						</span>
					</div>
