...
$APPLICATION->SetPageProperty("H1", "Международные авиаперевозки!!!");
$APPLICATION->SetPageProperty("description", "Международные авиаперевозки - ТК \"САТ\" | ВЫГОДНО! НАДЕЖНО! ВОВРЕМЯ! ☎ 0 800 30 99 09 (бесплатно по Украине)");
$APPLICATION->SetPageProperty("title", "Международные авиаперевозки SAT | Доставка документов и грузов авиатранспортом в более чем 220 стран мира");
$APPLICATION->SetTitle("Международная доставка SAT");
?>
<div class="international-banner" style="background-image: url('<?=SITE_TEMPLATE_PATH;?>/img/16-рус.png');">
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
				<div class="international-banner-content">
					<div class="international-banner-text clearfix">
						<h1><?echo getMessage("CHINE");?></h1>
                        <h2><?echo getMessage("CHINE2");?></h2>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-xs-12">
				<div class="post-content">
					<div class="breadcrumbs">
						...
						<span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"> 
							<a itemprop="url" href="<?echo SITE_DIR.'international/';?>"> 
								<span itemprop="title"><?=getMessage("INTERNATIONAL_PAGE");?></span> </a>| 
						</span>
						<span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"> 
							<span itemprop="title"><?echo getMessage("CHINE2");?></span> 
						</span>
					</div>
...
<?$APPLICATION->IncludeComponent("bitrix:form.result.new", "new_international_UAE", Array(
	"CACHE_TIME" => "3600",	// Время кеширования (сек.)
		...
		"COMPONENT_TEMPLATE" => "new_international",
		"SEF_FOLDER" => "/ru/international/avia/",	// Каталог ЧПУ (относительно корня сайта)
