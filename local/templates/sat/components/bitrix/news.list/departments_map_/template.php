	...
	<div class="page__map-overlay page__map-overlay--top">
		<div class="container-fluid">
			<div class="table__container table__container--department">
				<table class="table table-hover table--department table--accent">
					<thead>
						<tr>
							<th colspan="4" class="p-a-0">
								...
								<div class="table__col-2">
									<a href="<?=SITE_DIR?>/departments/" class="btn table__btn">Списком</a>
								</div>
								<div class="table__col-3">
									<span class="btn table__btn active">На карті</span>
								</div>
							</th>
						</tr>
					</thead>
