...
?>
<div id="akciya22" class="panel__container panel__container--main panel__container--main--banner m-b-0">
	<div id="akciya" class="container-fluid">
...
*/?>
	...
	<div class="panel__container-footer">
		<div class="container-fluid">
			<a href="<?=SITE_DIR?>/actions/" _type="button" class="btn btn--more" _style="border:none;">Більше акцій
