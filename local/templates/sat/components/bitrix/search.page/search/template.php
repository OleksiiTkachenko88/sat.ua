...
*/?>
	...
	<div class="search-result-hint"><?=GetMessage('SEARCH_NO_FOUND');?></div>
	<nav class="panel panel--news panel--space">
		<?if(count($arResult["SEARCH"]) > 0) { ?>
			<ul class="panel__item-list panel__item-list--less-air">
				<?foreach($arResult["SEARCH"] as $arItem) { ?>
					<li class="panel__item">
						<small class="panel__item-sup-title"><?=CIBlockFormatProperties::DateFormat('j F Y', strtotime($arItem['FULL_DATE_CHANGE']));?></small>
						<strong class="panel__item-title">
							<a href="<?echo $arItem["URL"]?>"><?echo $arItem["TITLE_FORMATED"]?></a>
						</strong>
						<div class="panel__item-text panel__item-text--line-2"><?echo $arItem["BODY_FORMATED"]?></div>
					</li>
				<? } ?>
			</ul>
