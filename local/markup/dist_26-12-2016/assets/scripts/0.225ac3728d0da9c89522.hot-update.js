	...
	(0, _jquery2.default)(function () {
	    ...
	    (0, _jquery2.default)(window).on('scroll', function () {
	        if ((0, _jquery2.default)(this).scrollTop() > offset) {
	            (0, _jquery2.default)('#sidenav').find('.sidenav__link.is-faded').fadeIn(duration);
	        } else {
	            (0, _jquery2.default)('#sidenav').find('.sidenav__link.is-faded').fadeOut(duration);
	        }
	    }).trigger('scroll');
	});
...
//# sourceMappingURL=0.225ac3728d0da9c89522.hot-update.js.map