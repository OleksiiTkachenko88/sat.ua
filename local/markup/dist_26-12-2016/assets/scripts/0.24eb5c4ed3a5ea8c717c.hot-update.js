	...
	(0, _jquery2.default)(function () {
	    ...
	    (0, _jquery2.default)(window).on('scroll', function () {
	        if ((0, _jquery2.default)(this).scrollTop() > offset) {
	            (0, _jquery2.default)('#sidenav').find('.sidenav__link.is-fade').fadeIn(duration);
	        } else {
	            (0, _jquery2.default)('#sidenav').find('.sidenav__link.is-fade').fadeOut(duration);
	        }
	    }).trigger('scroll');
	});
...
//# sourceMappingURL=0.24eb5c4ed3a5ea8c717c.hot-update.js.map