	...
	(0, _jquery2.default)(function () {
	    ...
	    (0, _jquery2.default)(window).on('scroll', function () {
	        if ((0, _jquery2.default)(this).scrollTop() > offset) {
	            (0, _jquery2.default)('#sidenav').find('.sidenav__link.is-fade').slideIn(duration);
	        } else {
	            (0, _jquery2.default)('#sidenav').find('.sidenav__link.is-fade').slideOut(duration);
	        }
	    }).trigger('scroll');
	});
...
//# sourceMappingURL=0.58c87a6c1929c0000fab.hot-update.js.map