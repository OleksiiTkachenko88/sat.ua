...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(function () {
	    ...
	    (0, _jquery2.default)(document).on('click', function () {
	        if ((0, _jquery2.default)(event.target).closest(".page__col-side").length > 0) {} else {
	            (0, _jquery2.default)('.page__col-side').removeClass('is-visible');
	        }
	    });
...
//# sourceMappingURL=0.3aeeaa74a34a62eea1d3.hot-update.js.map