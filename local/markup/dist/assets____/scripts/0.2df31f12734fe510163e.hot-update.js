...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(function () {
	    ...
	    (0, _jquery2.default)('.page__navbar-header .js-toggle-search').on('click', function () {
	        ...
	        $navbar.find('.js-display-1').addClass('hidden');
	        $navbar.find('.js-display-2').removeClass('hidden');
	
	        $navbar.find('.js-close').on('click', function () {
	            $navbar.find('.js-display-1').removeClass('hidden');
	            $navbar.find('.js-display-2').addClass('hidden');
	        });
	    });
...
//# sourceMappingURL=0.2df31f12734fe510163e.hot-update.js.map