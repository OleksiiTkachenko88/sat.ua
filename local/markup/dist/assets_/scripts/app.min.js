	    ...
	    (0, _jquery2.default)(function () {
	        ...
	        $window.scroll(function (e) {
	            ...
	            if ($pageHeader.css('position') == 'fixed') {
					...
					(0, _jquery2.default)('.mini_calc').addClass("minicalculator");
					(0, _jquery2.default)('.tracking').addClass("minicalculator");
					...
					(0, _jquery2.default)('.mini_calc').removeClass("minicalculator");
					(0, _jquery2.default)('.tracking').removeClass("minicalculator");
