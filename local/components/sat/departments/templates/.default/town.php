		...
		<div class="row">
			<div class="col-sm-12">
				<div class="breadcrumbs">
					...
					<span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"> 
						<a itemprop="url" href="<?echo $arResult["FOLDER"];?>"> 
							<span itemprop="title"><?echo $arResult["LIST_TITLE"]?></span> </a>| 
					</span>
					<span itemscope itemtype="http://data-vocabulary.org/Breadcrumb"> 
						<span itemprop="title"><?$APPLICATION->ShowTitle(false);;?></span> 
					</span>
				</div>
			</div>
		</div>
		...
		<div class="col-sm-12">
			<div class="department-panel">
				<div class="title-panel">
					...
					<!--<span><h1><?echo getMessage("DEPARTAMENTS");?></h1></span>-->
		...
		<div class="departments-region-wrap">
			...
			<?
				$APPLICATION->IncludeComponent(
					...
					"SEO_TITLE" => $arParams["TOWN_TITLE"],
					"SEO_PAGE_TITLE" => $arParams["PAGE_TOWN_TITLE"],
					"SEO_PAGE_DESC" => $arParams["PAGE_TOWN_DESC"],
					),
					$component
				);
			?>
