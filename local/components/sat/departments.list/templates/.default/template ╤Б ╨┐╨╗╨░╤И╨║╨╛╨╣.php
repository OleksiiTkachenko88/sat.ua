...
<a
  id="topWarning"
	href=<?echo getMessage("PASHA_LINK")?>
>
  <div id="header2">
    <p><?echo getMessage("PASHA")?></p>
  </div>
</a>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="item-head collapsed" data-toggle="collapse" href="<?echo '#'.$department['PROPERTY_NUMBER_VALUE'];?>" data-parent="#departments-list">
						...
						<div class="contacts">
							<?$arPhone = preg_split("/[,;]+/", $department["PROPERTY_PHONE_VALUE"], -1,  PREG_SPLIT_NO_EMPTY);?>
                ...
                <? } ?>
							...
							<div class="contcts"><p><a href="mailto:<?=$department["PROPERTY_EMAIL_VALUE"]?>"><?=$department["PROPERTY_EMAIL_VALUE"]?></a></p></div>
						</div>
					</div>
				</div>
			</div>
