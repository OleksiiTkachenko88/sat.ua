...
$APPLICATION->SetPageProperty("description", "Розрахувати вартість перевезення - Транспортна компанія “САТ” | ВИГІДНО! НАДІЙНО! ВЧАСНО! ");
          ...
          <div class="calculate-wrapper">
            ...
            <div class="wrapper-parcel-info clearfix">
              <div class="parcel-main-info clearfix">
                ...
                <div class="polupalet">Послуга застосовується за умови надання Клієнтом власної палети, розміри якої не перевищують 80х60 см.</div>          
