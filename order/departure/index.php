				...
				<!-- Hidden block for sklad or delivery -->
                                ...
                                <div class="wrapper-parcel-info clearfix">
                                    <div class="parcel-main-info clearfix">
                                        ...
                                        <div class="main-info-row">
                                        <div class="depature-declared"><span>Зверніть увагу! Якщо декларована вартість перевищує 100 000 грн,
                                            необхідно надати Представнику SAT документи, що підтверджують
                                            заявлену вартість вантажу.
                                            Упакування даного вантажу повинне відповідати правилам компанії,
                                            вказаним у документі <a href="http://test.sat.ua/about/recommend/pravila/">Стандарти/Правила/Сервіси</a></span>
                                        </div> 
                                        </div>
                                    </div>
 ...
 <style>
   ...
   .amountInfo { 
    ...
    padding-right: 15px; 
                        ...
                        <h2 style="color: #404041; padding: 8px 0px 8px 9px;">Дані відправника</h2>
                            ...
                            <!--   Платник --> 
                            <h2 style="color: #404041; padding: 8px 0px 8px 9px;">Платник</h2> 
                            <div class="phone" style="z-index:99999999"><img src="<?=SITE_TEMPLATE_PATH?>/img/icons/icon-gray17.png" alt="кпкфупукпфпфпфук">
                            ...
                            <!--   Отримувач -->   
                            <h2 style="color: #404041; padding: 8px 0px 8px 9px; z-index:99999999">Дані отримувача</h2> 
                            <div class="phone" style=""><img src="<?=SITE_TEMPLATE_PATH?>/img/icons/sender-phone.png" alt="">
...
<script src="<?=SITE_TEMPLATE_PATH?>/js/date-lib.js?20220922"></script>
<script src="<?=SITE_TEMPLATE_PATH?>/js/calc_old.js?20220922"></script>
<script src="<?=SITE_TEMPLATE_PATH?>/js/script_old.js?20220922"></script>
