...
$APPLICATION->SetPageProperty("description", "Доставка до дверей одержувача - Транспортна компанія “САТ” | ВИГІДНО! НАДІЙНО! ВЧАСНО! ☎ 066 830 99 09; 098 830 99 09; 073 830 99 09 (вартість дзвінків згідно тарифів вашого оператора)");
$APPLICATION->SetPageProperty("title", "Доставка до дверей одержувача | Транспортна компанія “САТ”");
$APPLICATION->SetTitle("Замовити доставку за адресою отримувача");
...
?>
	...
	<style>
		...
		@media (max-width: 500px){
			.calculate-wrapper .section-from .sender-info .address, .calculate-wrapper .section-from .sender-info .person, .calculate-wrapper .section-from .sender-info .phone .delivery-city{float:left; width:100%; padding: 7px 0 7px 5px; min-width:244px;}
								...
								<div class="range-sizes-wrapper" style="display:none;">
									...
									<div class="range_wrap">
										<div class="price-range-details">
											...
											<input type="number" placeholder="0" class="slider-range-value"
												   id="length-range-value" name="length" value=""><span>cм</span>
										</div>
									...
									<div class="range_wrap">
										<div class="price-range-details">
											...
											<input type="number" placeholder="0" class="slider-range-value"
												   id="height-range-value"  name="height" value=""><span>cм</span>
										</div>
										<div class="slider-range-row">
											<span>0 cм</span>
...
<style>
   ...
   .pidyom {
    margin-left: 1%; /* Отступы слева от элемента */
								...
								<div class="pidyom"><strong>Зверніть увагу, підйом на поверх тарифікується окремо. <a href="https://www.sat.ua/upload/sat_doc/Price_new.pdf">Деталі умов доставки за посиланням.</a></strong></div>
						...
						<div class="tracking-error">
                            ...
                            Номер відправлення складається з дев'яти цифр, наприклад: 123456789. Перевірте свій номер і спробуйте ще раз.
                            <br><br>
...
<script>
  (() => {
    const onSubmit = () => console.log('delivery') || gtag('event', 'delivery', {'event_category': 'klik'});
