...
$APPLICATION->SetPageProperty("description", "Детально про логістичну компанії \"САТ\" | ВИГІДНО! НАДІЙНО! ПІД ЧАС! ☎ 066 830 99 09; 098 830 99 09; 073 830 99 09 (вартість дзвінків згідно тарифів вашого оператора)");
$APPLICATION->SetPageProperty("title", "Логістична компанія України | Про компанію \"САТ\" - Транспортна логістика");
$APPLICATION->SetPageProperty("BTN_TEXT", "ОТРИМАЙ НАДПОШТОВІ МОЖЛИВОСТІ");
$APPLICATION->SetPageProperty("H2", "БЕЗДОГАННО ДОСТАВЛЯЄМО ВАНТАЖІ ПО УКРАЇНІ ТА СВІТУ");
$APPLICATION->SetPageProperty("H1", "компанія SAT");
$APPLICATION->SetTitle("SAT - ЛОГІСТИКА ДЛЯ БІЗНЕСУ");
?>
   <div class="strategy-banner" style="background-image: url('<?=SITE_TEMPLATE_PATH;?>/img/strategy-banner-ua-new.png');">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="strategy-banner-content">
                        <div class="strategy-banner-text clearfix">
                            ...
                            <h2><?= $APPLICATION->GetPageProperty("H2");?></h2>
                        </div>
                    </div>
                </div>
            </div>
