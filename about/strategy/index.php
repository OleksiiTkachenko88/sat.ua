...
$APPLICATION->SetPageProperty("description", "Легенда “САТ” - Транспортна компанія “САТ” | ВИГІДНО! НАДІЙНО! ВЧАСНО! ☎ 066 830 99 09; 098 830 99 09; 073 830 99 09 (вартість дзвінків згідно тарифів вашого оператора)");
$APPLICATION->SetPageProperty("title", "Легенда “САТ” | Транспортна компанія “САТ”");
$APPLICATION->SetTitle("Легенда «SАТ» - транспортні послуги по Україні");
$APPLICATION->SetPageProperty("BTN_TEXT", "ОТРИМАЙ НАДПОШТОВІ МОЖЛИВОСТІ");
$APPLICATION->SetPageProperty("H2", "ВІД адресноЇ доставки до КЕРУВАННЯ замовленнями ТА НАДАННЯ доДАТКОВИХ СЕРВІСІВ І ПОСЛУГ");
$APPLICATION->SetPageProperty("H1", "Легенда");
$APPLICATION->SetTitle("Компанія SAT");
?>
