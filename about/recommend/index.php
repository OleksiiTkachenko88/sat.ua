...
$APPLICATION->SetPageProperty("description", "SAT рекомендує - Транспортна компанія “САТ” | ВИГІДНО! НАДІЙНО! ВЧАСНО! ☎ 0 800 30 99 09 (безкоштовно по Україні)");
$APPLICATION->SetPageProperty("title", "SAT рекомендує | Транспортна компанія “САТ”");
$APPLICATION->SetTitle("SAT рекомендує");
?>
