...
$APPLICATION->SetPageProperty("description", "Відстеження вантажу - Транспортна компанія “САТ” | ВИГІДНО! НАДІЙНО! ВЧАСНО! ☎ 0 800 30 99 09 (безкоштовно по Україні)");
...
$(document).ready(function () {
	...
	$('.track-action').on('click', function (e) {
		e.preventDefault();
                            ...
                            <div class="td-location">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="right-text small-text to-date-question" style="<?=($track['status']=='Заявлено до відправки')?"visibility:hidden":"";?>" data-description="<?echo getMessage("APPROX_DATE");?>"><?echo getInfo('to_date', $track);?></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <div class="dark right-text middle-text"><?echo getInfo('to_type', $track);?></div>
                                        </td>
                                    </tr>
                                </table>
                            </div>
	...
	.tracking-table .pay-btn-zone .pay-button .commission-block .commission-text{
		font-size: .55rem;
						...
						<div class="choice-payment-method">
							<div class="title">Оберіть один з варіантів оплати</div>
                        ...
                        <div class="additional-information">
										...
										<tr>
											...
											<td>
												<div class="dark" style="white-space: nowrap;"><?echo getInfo('volume', $track);?> м<sup>3</sup></div>
																...
																<div style='display: none' id='se89'>
                                	<?= json_encode($data['addServices']); ?>
																</div>
                                <div class="td-info">
                                  <table>
                                    <tr>
                                    ...
                                    <tr>
                                      <?
                                        $i = 0;
                                        foreach ($data['addServices'] as $k => $v) {
                                      ?>
                                        <td>
                                          <div class="dark upper"><i class="fa fa-check" aria-hidden="true"></i><?echo $v['serviceDescription'];?>
                                          </div>
                                        </td>
                                      <?
                                        if ($i == 2 ) {
                            ...
                            <div class="row-table row-sub clearfix">
                                <div class="td-location">
                                    ...
                                    <div class="middle-text"><?echo getInfo('payer_sum', $track);?> грн <?=getMessage("MAKE_PAYMENT");?> <?echo getInfo('payer', $track);?></div>
